...
**Sel-prepared choropleth maps**

We use different classification methods supported by tmap and compare their differences.
...
We use quantile method but with different numbers of classes (i.e. 2, 6, 10, 20) to compare the differences.

Tackle with NA by 0 value
...
tm_shape(mpsz_pop2020) +
  tm_fill("DEPENDENCY",
          ...
          palette = "Blues",
          thres.poly = 0) + 
  tm_facets(by = "REGION_N", free.coords = FALSE, drop.shapes = TRUE) +
